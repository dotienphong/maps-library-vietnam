...
| B3 | Rà soát **nhãn hiệu** tên "MapsLibVN" với chính sách nhãn hiệu của MapLibre; nếu bị phản đối thì đổi tên gói trước khi publish npm công khai | spec 12.4 và 14 | trước khi publish npm | ☐ **cập nhật 04/09/2026** — `docs/legal/b3-ra-soat-nhan-hieu.md`: MapLibre **không có** chính sách nhãn hiệu công khai, nhãn hiệu do Open Source Collective nắm; rủi ro đánh giá thấp–trung bình; đã thêm dòng miễn trừ liên kết vào notices. **Tra cứu WIPO + Cục SHTT đã xong: không có đơn trùng.** **Còn lại (chỉ người làm được):** gửi thư hỏi `team@maplibre.org` (mẫu có sẵn trong hồ sơ), chờ phản hồi trước khi publish |
