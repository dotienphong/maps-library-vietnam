...
**Trạng thái:** Task 0–7 hoàn tất 06/09/2026. Task 8: **8.1–8.2, 8.5, 8.6 xong** (8.5 đo lại và kết luận 07/09, cổng p95 của 8.6 ĐẠT); **8.3/8.4 còn đỏ** vì độ phủ upstream và ground truth fixture (việc 5), 8.7 chờ 8.3. Task 9: **9.1 xong**, 9.2 làm một phần — đã áp migration 0008 lên production để **khắc phục sự cố `/v1/autocomplete` 503** (xem DEVLOG 07/09), 9.4–9.7 chặn. Không tick hoàn tất plan. Hạng mục 2 đã có plan riêng và đã đóng. Chưa tuyên bố độ phủ toàn quốc vì ledger nguồn còn khoảng thiếu Khánh Hòa/Jan→Jun.
