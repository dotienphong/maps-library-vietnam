...
| **M5** Phát hành nội bộ | docs 5 phút + trang tự host, trang giấy phép/độ chính xác, seed key cho app kết bạn, báo cáo tuần, `THIRD_PARTY_NOTICES.md`, điều khoản tenant | App kết bạn nhúng được bằng key riêng; báo cáo sử dụng tuần đầu; checklist pháp lý ghi rõ việc tay còn lại | 1 tuần |
