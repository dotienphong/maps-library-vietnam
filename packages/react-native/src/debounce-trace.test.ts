...
describe('@mapslibvn/react-native — số lượt Places cho một phiên gõ thật', () => {
  ...
  afterAll(() => {
    ...
    writeFileSync(
      `${DIR}/2026-09-15-counts-react-native.json`,
      `${JSON.stringify({ package: '@mapslibvn/react-native', rows }, null, 2)}\n`,
    );
  });
